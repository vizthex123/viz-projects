...
mods.extendedcrafting.TableCrafting.addShaped("quintessence", 4, <item:kubejs:quintessence>,
	...
	[empty, empty, <item:ironchest:obsidian_chest>|<item:ironchest:trapped_obsidian_chest>, <item:industrialforegoing:mycelial_reactor>, <item:quantumquarryplus:quantum_quarry_plus>, <item:deepresonance:generator_controller>, <item:ae2things:disk_drive_64k>, empty, empty],
