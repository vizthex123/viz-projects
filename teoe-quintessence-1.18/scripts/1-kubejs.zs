...
craftingTable.addShapeless("glue_sharp_bones", glue, [<item:aquamirae:sharp_bones>, <item:aquamirae:sharp_bones>, <item:aquamirae:sharp_bones>, <item:aquamirae:sharp_bones>, <item:aquamirae:sharp_bones>, <item:minecraft:paper>]);
...
composter.setValue(compressed_sawdust, 0.25);
/*
// Clump
