...
<recipetype:thermal:smelter>.addRecipe("smelt_raw_nickel_block", [<item:create:zinc_ingot>*9, <item:thermal:copper_nugget>*9 % 50, iridium % 15], [<item:thermal:raw_nickel_block>], 6.0, 6000);
...
<recipetype:thermal:smelter>.addRecipe("smelt_raw_pendorite_block", [<item:byg:pendorite_scraps>*9, <item:minecraft:netherite_scrap>*9 % 50, iridium*2, iridium % 75], [<item:byg:raw_pendorite_block>], 6.5, 9000);

<recipetype:thermal:smelter>.addRecipe("smelt_raw_platinum_block", [<item:ob_core:platinum_ingot>*9, iridium % 25], [<item:ob_core:raw_platinum_block>], 30, 8000);
...
<recipetype:thermal:smelter>.addRecipe("smelt_raw_pendorite", [<item:byg:pendorite_scraps>, <item:minecraft:netherite_scrap> % 75, iridium % 25], [<item:byg:raw_pendorite>], 0.7, 3600);
...
<recipetype:thermal:smelter>.addRecipe("smelt_raw_platinum", [<item:ob_core:platinum_ingot>, iridium % 75], [<item:byg:raw_pendorite>], 0.7, 3600);
