...
ServerEvents.tags("item", e => {
    ...
    // Magenta
    e.add("revolution:dye_materials/magenta", ["allium", "autumnity:autumn_crocus", "biomesoplenty:wildflower", "upgrade_aquatic:mulberry", "#upgrade_aquatic:bubble_corals"])
    ...
    // Light Blue
    e.add("revolution:dye_materials/light_blue", ["blue_orchid", "alexscaves:bioluminesscence", "biomesoplenty:icy_iris", "outer_end:azure_bud", "yungscavebiomes:frost_lily", "#upgrade_aquatic:petal_corals"])
    ...
    e.add("revolution:dye_materials/light_blue_extractables", ["#revolution:dye_materials/light_blue", "thermal:frost_melon_slice"])
    ...
    // Pink
    e.add("revolution:dye_materials/pink", ["pink_petals", "pink_tulip", "biomesoplenty:pink_daffodil", "biomesoplenty:pink_hibiscus", "buzzier_bees:pink_clover", "ecologics:azalea_flower", "upgrade_aquatic:pink_searocket", "yungscavebiomes:prickly_peach", "#upgrade_aquatic:brain_corals"])
    ...
    // Extractables tag for the Separator
    e.add("revolution:dye_materials/cyan_extractables", ["#revolution:dye_materials/cyan", "warped_fungus", "warped_roots", "twisting_vines"])
    ...
    // Blue
    e.add("revolution:dye_materials/blue", ["cornflower", "#upgrade_aquatic:tube_corals"])
    ...
    // Green
    e.add("revolution:dye_materials/green", ["#revolution:mosslike", "alexscaves:archaic_vine", "#upgrade_aquatic:moss_corals"])
    ...
    e.add("revolution:dye_materials/green_extractables", ["#revolution:dye_materials/green", "#revolution:cacti", "big_dripleaf", "small_dripleaf"])
    ...
    // Extractables tag for the Separator
    e.add("revolution:dye_materials/red_extractables", ["#revolution:dye_materials/red", "melon_slice", "crimson_fungus", "crimson_roots", "nether_wart", "redstone", "weeping_vines"])
...
ServerEvents.recipes(e => {
    ...
    e.recipes.thermal.centrifuge(["2x white_dye", "2x pink_dye"], "#revolution:shells", 1).energy(1600).id("kubejs:extract_white_dye_shells")
    ...
    // Light Blue
    e.recipes.thermal.centrifuge(["3x light_blue_dye"], "#revolution:dye_materials/light_blue_extractables", 1).energy(1600).id("kubejs:extract_light_blue_dye")
    ...
    // Cyan
    e.recipes.thermal.centrifuge(["3x cyan_dye"], "#revolution:dye_materials/cyan_extractables", 1).energy(1600).id("kubejs:extract_cyan_dye")
    ...
    // Green
    e.recipes.thermal.centrifuge(["3x green_dye"], "#revolution:dye_materials/green_extractables", 1).energy(1600).id("kubejs:extract_green_dye")
    ...
    // Red
    e.recipes.thermal.centrifuge(["3x red_dye"], "#revolution:dye_materials/red_extractables", 1).energy(1600).id("kubejs:extract_red_dye")
